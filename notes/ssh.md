...
Il faut générer une paire de clé :
...
- Interdire aussi les mdp vides
```bash
PasswordAuthentication no
PermitEmptyPasswords no
```

### Réduire le délai de connexion. Exemple :30 secondes .
...
### Désactiver la redirection X11 (doit être désactivée par défaut)
